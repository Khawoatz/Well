...
import com.example.khawoat_rmbp.well.Adapter.TimerService;
...
import com.example.khawoat_rmbp.well.SignUp;
...
public class Map_User extends FragmentActivity implements OnMapReadyCallback,
    ...
    private static final String URL_FOR_LOCATION_UPDATE = "http://203.158.131.67/~Adminwell/App/Update_Location_Mass.php";
...
//                String Lat_mass = Double.toString(latitude);
//                String Long_mass = Double.toString(longitude);


                //Add pointer to the map at location
//                updateLocation(Lat_mass,Long_mass,"2");
    ...
    private void updateLocation(final String latmass, final String longmass, final String resid) {
        // Tag used to cancel the request
        String cancel_req_tag = "updateLocation";
        StringRequest strReq = new StringRequest(Request.Method.POST, URL_FOR_LOCATION_UPDATE, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext(),
                        "เออเร่ออิสัส", Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
            protected java.util.Map<String, String> getParams() {
                ...
                params.put("latmass", latmass);
                params.put("longmass",longmass);
    ...
    private void getLocation(final String id) {
        ...
        final StringRequest stringRequest = new StringRequest(Request.Method.POST,URL_FOR_GET_LOCATION, new Response.Listener<String>(){
            ...
            protected java.util.Map<String, String> getParams() {
                ...
                java.util.Map<String, String> params = new HashMap<String, String>();
                params.put("ResId", ResID); //  ชื่อซ้ายตรงกับ php ชื่อขวาตรงกับข้างบน
