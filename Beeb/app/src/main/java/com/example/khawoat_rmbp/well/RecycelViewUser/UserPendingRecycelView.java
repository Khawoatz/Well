...
/**
 * Created by jah on 4/9/2018.
 */

public class UserPendingRecycelView extends RecyclerView.Adapter<UserPendingRecycelView.ViewHolder> {
    private Context context;
    private List<DataHistoryUser> dataHistoryUserList;
    DataHistoryUser dataHistoryUser;
    public UserPendingRecycelView(Context context,List<DataHistoryUser> DataHistoryUserList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.data_pending_user, parent, false);
