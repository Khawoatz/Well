...
public class TitleView extends FrameLayout {
    ...
    public void setFixRightButtonPadingTop(){
        mRightText.setPadding(mRightText.getPaddingLeft(), dip2px(10), mRightText.getPaddingRight(), mRightText.getPaddingBottom());
    }
    ...
    public void setFixRightButtonPadingTop(int dp){
        mRightText.setPadding(mRightText.getPaddingLeft(), dip2px(dp),mRightText.getPaddingRight(),mRightText.getPaddingBottom());
    }
    ...
    protected void onFinishInflate() {
        ...
        mLeftParent = (FrameLayout) root.findViewById(R.id.title_left_parent);
        mLeftText = (TextView) root.findViewById(R.id.title_left_text);
        mLeftText.setTextColor(getResources().getColor(R.color.white1));

        //mLeftText.setTextSize(TypedValue.COMPLEX_UNIT_SP, 24);
        mLeftCustomViewContainer = (FrameLayout) root.findViewById(R.id.title_left_custom_view);
        mCenterParent = (FrameLayout) root.findViewById(R.id.title_center_parent);
        mCenterText = (TextView) root.findViewById(R.id.title_center_text);
        mCenterText.setTextColor(getResources().getColor(R.color.white1));

        mCenterCustomViewContainer = (FrameLayout) root.findViewById(R.id.title_center_custom_view);
        mRightParent = (FrameLayout) root.findViewById(R.id.title_right_parent);
        mRightText = (TextView) root.findViewById(R.id.title_right_text);
        mRightText.setTextColor(getResources().getColor(R.color.white1));

        mRightCustomViewContainer = (FrameLayout) root.findViewById(R.id.title_right_custom_view);
